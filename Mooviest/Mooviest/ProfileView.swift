...
class ProfileView: UIView {
    ...
    func setupConstraints() {
        ...
        headerView.addConstraint(headerLabel.centerXAnchor.constraint(equalTo: headerView.centerXAnchor))
        headerView.addConstraint(headerLabel.widthAnchor.constraint(equalTo: headerView.widthAnchor,multiplier: 0.5))
        ...
        bodyScrollView.addConstraint(coverImageView.topAnchor.constraint(equalTo: bodyScrollView.topAnchor,constant: 100))
        bodyScrollView.addConstraint(coverImageView.centerXAnchor.constraint(equalTo: bodyScrollView.centerXAnchor))
        bodyScrollView.addConstraint(coverImageView.widthAnchor.constraint(equalTo: bodyScrollView.widthAnchor, multiplier: 0.4))
        bodyScrollView.addConstraint(coverImageView.heightAnchor.constraint(equalTo: coverImageView.widthAnchor))
        
        bodyScrollView.addConstraint(titleLabel.topAnchor.constraint(equalTo: coverImageView.bottomAnchor,constant: 5))
        bodyScrollView.addConstraint(titleLabel.centerXAnchor.constraint(equalTo: bodyScrollView.centerXAnchor))
        ...
        bodyScrollView.addConstraint(infoView.topAnchor.constraint(equalTo: titleLabel.bottomAnchor,constant: 50))
        ...
        bodyScrollView.addConstraint(castView.topAnchor.constraint(equalTo: titleLabel.bottomAnchor,constant: 50))
        ...
        bodyScrollView.addConstraint(seeView.topAnchor.constraint(equalTo: titleLabel.bottomAnchor,constant: 50))
        ...
        addConstraint(barSegmentedView.topAnchor.constraint(equalTo: titleLabel.bottomAnchor,constant: 10))
